...
window.addEventListener("load", function() {
	...
	var colorPoints = [
		new ColorPoint(0, 0, new Color(999, 999, 999)),
		new ColorPoint(0, 1, new Color(999, 999, 999)),
		new ColorPoint(1, 0, new Color(999, 999, 999)),
		new ColorPoint(1, 1, new Color(999, 999, 999))
	];
